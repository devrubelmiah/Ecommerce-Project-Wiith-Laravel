...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
    <form method="POST" action="{{ route('admin.post-tags.store') }}">
      @csrf

      <div class="form-group">
        <label for="title">Title:</label>
        <input type="text" class="form-control @error('title') is-invalid @enderror" placeholder="Enter tag" id="title" name="title" value="{{old('title')}}" >
        @error('title')
